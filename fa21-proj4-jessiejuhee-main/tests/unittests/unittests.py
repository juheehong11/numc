...
class TestAbs(TestCase):
    ...
    def test_large_abs(self):
        dp_mat, nc_mat = rand_dp_nc_matrix(1001, 1001, seed=0)
        is_correct, speed_up = compute([dp_mat], [nc_mat], "abs")
        self.assertTrue(is_correct)
        print_speedup(speed_up)
...
class TestNeg(TestCase):
   ...
   def test_medium_neg(self):
       dp_mat, nc_mat = rand_dp_nc_matrix(501, 501, seed=0)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)

   def test_large_neg(self):
       dp_mat, nc_mat = rand_dp_nc_matrix(1005, 1005, seed=0)
       is_correct, speed_up = compute([dp_mat], [nc_mat], "neg")
       self.assertTrue(is_correct)
       print_speedup(speed_up)
...
class TestMul(TestCase):
    def test_small_mul(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(50, 30, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(30, 45, seed=1)
    ...
    def test_medium_mul(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(101, 150, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(150, 203, seed=1)
        #dp_mat1, nc_mat1 = rand_dp_nc_matrix(350, 350, seed=0)
        #dp_mat2, nc_mat2 = rand_dp_nc_matrix(350, 350, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
        print_speedup(speed_up)

    def test_large_mul(self):
        dp_mat1, nc_mat1 = rand_dp_nc_matrix(1005, 800, seed=0)
        dp_mat2, nc_mat2 = rand_dp_nc_matrix(800, 745, seed=1)
        #dp_mat1, nc_mat1 = rand_dp_nc_matrix(1000, 1000, seed=0)
        #dp_mat2, nc_mat2 = rand_dp_nc_matrix(1000, 1000, seed=1)
        is_correct, speed_up = compute([dp_mat1, dp_mat2], [nc_mat1, nc_mat2], "mul")
        self.assertTrue(is_correct)
